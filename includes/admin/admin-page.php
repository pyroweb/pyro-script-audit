                        ...
                        <tr data-handle="<?php echo esc_attr( $handle ); ?>">
                            ...
                            <td class="column-actions"> <?php // ACTION BUTTONS ?>
                                ...
                                <?php elseif ($current_tab === 'dequeued'): ?>
                                    ...
                                    <button class="button button-small pyro-sa-conditions-btn" data-handle="<?php echo esc_attr($handle); ?>" data-api-path="ps-sa/v1/rules/"><?php esc_html_e('Conditions', 'pyro-script-audit'); ?></button>
                                <?php elseif ($current_tab === 'manual'): ?>
                                    ...
                                    <button class="button button-small pyro-sa-conditions-btn" data-handle="<?php echo esc_attr($handle); ?>" data-api-path="ps-sa/v1/manual-rules/" style="margin-right:5px;"><?php esc_html_e('Conditions', 'pyro-script-audit'); ?></button>
...
function pyro_sa_render_rule_builder_modal() {
    // All the HTML for your #ps-sa-modal goes here
    // This helps keep pyro_sa_render_admin_page cleaner
    ?>
    <div id="ps-sa-modal" style="display:none" aria-labelledby="ps-sa-modal-title" role="dialog" aria-modal="true">
      <div class="box">
        <h3 id="ps-sa-modal-title"><?php esc_html_e('Edit context rules for', 'pyro-script-audit'); ?> <span id="ps-sa-current" style="font-weight:bold;"></span></h3>        
        
        <div id="pyro-sa-rule-modal-messages" class="notice" style="display:none; margin-bottom:10px; padding: 10px;"></div>

        <p><label for="ps-sa-type"><?php esc_html_e('Rule type:', 'pyro-script-audit'); ?></label>
          <select id="ps-sa-type">
        ...
        <div id="ps-sa-extra" style="margin-top:8px; margin-bottom: 10px;"></div>
        <button type="button" class="button" id="ps-sa-add"><?php esc_html_e('Add rule', 'pyro-script-audit'); ?></button>

        <p>
            <label for="ps-sa-mode" style="display:block;margin:15px 0 5px;"><?php esc_html_e('Matching mode:', 'pyro-script-audit'); ?></label>
            <select id="ps-sa-mode">
        ...
        <div id="ps-sa-list" class="rule-list-container"></div>

        <p class="submit" style="margin-top:20px; display:flex; justify-content:space-between;">
          <button type="button" class="button button-primary" id="ps-sa-save"><?php esc_html_e('Save Conditions', 'pyro-script-audit'); ?></button>
          <button type="button" class="button" id="ps-sa-close"><?php esc_html_e('Cancel', 'pyro-script-audit'); ?></button>
        </p>
      </div>
    </div>
    <?php
...
function pyro_sa_render_manual_script_modal() {
    // All the HTML for your #ps-sa-manual-script-entry-modal goes here
    ?>
    <div id="ps-sa-manual-script-entry-modal" style="display:none;" aria-labelledby="ps-sa-manual-script-modal-title-h2" role="dialog" aria-modal="true">
      <div class="box">
        <h2 id="ps-sa-manual-script-modal-title-h2" style="margin-top:0;"><?php esc_html_e('Add New Script', 'pyro-script-audit');?></h2>
        <form id="ps-sa-manual-script-form">
          <input type="hidden" id="ps-sa-manual-script-modal-mode" value="add">
          <input type="hidden" id="ps-sa-manual-script-original-handle" value="">

          <p><label for="ps-sa-manual-handle"><strong><?php esc_html_e('Handle:', 'pyro-script-audit'); ?></strong> <span style="color:red;">*</span></label><br>
             <input type="text" id="ps-sa-manual-handle" name="handle" class="widefat" required pattern="[a-zA-Z0-9_-]+" title="<?php esc_attr_e('Alphanumeric, underscores, hyphens only. No spaces.', 'pyro-script-audit');?>">
             <small><?php esc_html_e('A unique identifier (e.g., my-custom-script). Cannot be changed after creation.', 'pyro-script-audit');?></small></p>

          <p><label for="ps-sa-manual-src"><strong><?php esc_html_e('Source URL (src):', 'pyro-script-audit'); ?></strong> <span style="color:red;">*</span></label><br>
             <input type="url" id="ps-sa-manual-src" name="src" class="widefat" required placeholder="https://example.com/path/to/script.js"></p>

          <p><label for="ps-sa-manual-ver"><?php esc_html_e('Version (ver):', 'pyro-script-audit'); ?></label><br>
             <input type="text" id="ps-sa-manual-ver" name="ver" class="widefat" placeholder="1.0.0"></p>

          <p><label for="ps-sa-manual-deps"><?php esc_html_e('Dependencies (deps, comma-separated):', 'pyro-script-audit'); ?></label><br>
             <input type="text" id="ps-sa-manual-deps" name="deps" class="widefat" placeholder="jquery, other-handle">
             <small><?php esc_html_e('Enter script handles, e.g., jquery.', 'pyro-script-audit');?></small></p>

          <p style="margin-bottom: 5px;"><label><input type="checkbox" id="ps-sa-manual-in-footer" name="in_footer" value="1"> <?php esc_html_e('Load in footer?', 'pyro-script-audit'); ?></label></p>

          <p><label for="ps-sa-manual-strategy"><?php esc_html_e('Strategy:', 'pyro-script-audit'); ?></label><br>
             <select id="ps-sa-manual-strategy" name="strategy" class="widefat">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center;">
            <button type="submit" class="button button-primary" id="ps-sa-save-manual-script-btn"><?php esc_html_e('Save Script', 'pyro-script-audit'); ?></button>
            <button type="button" id="ps-sa-manual-script-modal-close-btn" class="button"><?php esc_html_e('Cancel', 'pyro-script-audit'); ?></button>
          </div>
        </form>
      </div>
    </div>
